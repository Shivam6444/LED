...
function setup(){
	...
	line = createSprite(0,400,8000,75);
 	...
 	player = createSprite(50,390,20,30);
  	...
  	//coins = new Group();
//this is how you would make a bunch of coins but I need to place them and dont want to write an algorithm for the weird x,y cords
